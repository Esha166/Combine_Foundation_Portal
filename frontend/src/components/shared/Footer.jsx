...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-gray-950 text-gray-300 border-t border-gray-900 pt-16 pb-8">
      <Container>
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-gray-900 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all text-gray-400"
                aria-label="Facebook"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              </a>

              {/* Official Website (Replacing Twitter) */}
              <a
                href="https://combinegrp.com/combine-foundation/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-900 flex items-center justify-center hover:bg-orange-600 hover:text-white transition-all text-gray-400"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/combinefoundation/reels/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-900 flex items-center justify-center hover:bg-pink-600 hover:text-white transition-all text-gray-400"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-900 flex items-center justify-center hover:bg-blue-700 hover:text-white transition-all text-gray-400"
                aria-label="LinkedIn"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <button onClick={() => handleScroll('home')} className="text-sm text-gray-400 hover:text-orange-500 transition-colors bg-transparent border-none p-0 cursor-pointer text-left">Home</button>
              </li>
              <li>
                <button onClick={() => handleScroll('about')} className="text-sm text-gray-400 hover:text-orange-500 transition-colors bg-transparent border-none p-0 cursor-pointer text-left">About Us</button>
              </li>
              <li>
